...
class NewAgentRequestAdmin(AuditlogMixin, admin.ModelAdmin):
...
class AgentAdmin(AuditlogMixin, GuardedModelAdmin):  # type: ignore[misc]
...
class AgentAtClubAdmin(AuditlogMixin, admin.ModelAdmin):
